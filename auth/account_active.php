...
<table width="416" border="0" align="center" class="table_confirs" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="104" align="center" valign="top">
        <span class="ipblock"><h1 style="color:#c43a3a; font-weight:bold;">OOPSS!!</h1></span>
        This Account Already Active with some another system!!<br />
        Please Contact your Administrator for active your account.
