...
<script type="text/javascript">
   function showSearchWait(){
       ...
       var subW = $.ajax({
				url: '../master/form/waiting-order-list.php',
				type: 'POST',
				data: {order : or, area : ar, services: sr, cabtype : ct, boktype : bt, enddate : dae, sermode:bot},
				dataType: "html",
				cache: false
			});
	subW.done(function(data, textStatus, jqXHR){
		$("#waitCabList").html(data);
	});
...
<table width="100%" border="0" align="center" >
     <tr><th colspan="10" align="center" class="table-header">Waiting Order <a href="#" id="showtoolbox">Show</a></th></tr>
    <tr><td align="left" valign="top">
            ...
            <table width="100%">
                <tr>
                    <td>
                        <a href="#" id="../master/form/booked-order-list.php" onClick="showMainAction(this.id)" class="NavButton">ALL</a>
                    </td>
                ...
                <tr>
                    <td colspan="2">&nbsp;</td>
                            ...
                            <td><input type="button" class="NavButton" onclick="showSearchWait()" value="SHOW" /></td>
                </tr>
            </table>
            </form>
            </div>
          ...
          <tr><td colspan="6" align="left" valign="top">
			<div id="waitCabList"><p align="center"><img src="images/ajax-loader.gif" /><br>Please Wait..</p></div>
          </td></tr>
        </table>
</div>
		  
<script language="javascript">
	var uri = "../master/form/waiting-order-list.php?mode=ALL&type=ALL";
