...
require_once "../../core/php/connection.php";
 ?> 
<form  name="frmCreateDriver" id="frmCreateDriver" method="post" action="../master/php/add-new-driver-edit-cab.php" enctype="multipart/form-data">
...
?>
<input type="hidden"  name="cabid" value="<?php echo $_GET['cid']; ?>" />
